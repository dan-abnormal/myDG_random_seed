...
def main(boosting, time_min, time_max, dg_weight_1st_order, dg_weight_2nd_order, cond, pretrained_classifier_ckpt, discriminator_ckpt, save_type, batch_size, do_seed, seed, eps_scaler, num_samples, network_pkl, outdir, class_idx, device, **sampler_kwargs):
    ## Set seed
    if do_seed:
        import random
        random.seed(seed)
